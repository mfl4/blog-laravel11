                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="flex items-baseline ml-10 space-x-4">
                                ...
                                <a href="/blog"
                                    class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">Blog</a>
                                <a href="/about"
                                    class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">About</a>
                                <a href="/contact"
                                    class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">Contact</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
